<!--
{
  ...
  "title": "Een Nieuw Menu Toevoegen",
  "description": "", 
  "author": ""
}
-->
...
![Menu's lijst](../../../en/images/menus/adding-a-new-menu/01-menus-manage.png)
...
- Vul in het gegevensinvoerformulier voor het menu de volgende velden in:
  ...
  - **Beschrijving**: Hoewel het niet vereist is, is dit vaak nuttig op een site met veel menu's. Het verschijnt onder de *Titel* in de menulijst zoals hierboven geïllustreerd.<br>
    ![Nieuw Menu](../../../en/images/menus/adding-a-new-menu/02-menus-new.png)
- **Opslaan & Sluiten**
...
![Gegevensinvoerformulier van de menu-module](../../../en/images/menus/adding-a-new-menu/03-menus-module.png)
...
![Gegevensinvoerformulier voor menu-items](../../../en/images/menus/adding-a-new-menu/04-menus-single-article.png)
...
![Menu weergave](../../../en/images/menus/adding-a-new-menu/05-menus-display.png)
