...
Het Joomla! CMS bevat een eigen aangepaste Font Awesome Font Set. Deze icoonfonts zijn standaard beschikbaar voor gebruik in de *Cassiopeia* en *Atum* sjablonen.

Icoonfonts die zijn gemapt in `/media/system/scss/_icomoon.scss` kunnen worden aangeroepen met een `name-of-icon">` tag en een {spatie} `</span>`. Bijvoorbeeld:

```html
<span class="icon-joomla"> </span>
```

Zal het Joomla! icoon tonen: <span class="icon-joomla">&nbsp;</span>

Icoonfonts die niet zijn gemapt, kunnen worden aangeroepen met een
`<span class="far fa-name-of-icon">` tag en een {spatie} `</span>`. Voorbeeld:

```php
<i class="fa fa-adjust"></i>
```

Zal een aanpas-icoon tonen: <i class="fa fa-adjust"></i>

## Lettergrootte

Omdat de iconen lettertypen zijn, kun je de grootte ervan regelen met een extra klasse of een style= statement. Uiteraard moet je de klasse definiëren in je .css of .less stylesheet-bestand.
...
Hier is de Joomla!-icoon met aangepaste grootte: <span class="icon-joomla" style="font-size:24px;">&nbsp;</span>
