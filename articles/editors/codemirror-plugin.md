...
![CodeMirror-plugin-instellingen](../../../en/images/editors/codemirror-plugin/01-codemirror-plugin-tab.png)

De volgende screenshot toont de HTML-kleuraccentuering en de *CMS-content* geïmplementeerd als een rij knoppen:

![CodeMirror in gebruik](../../../en/images/editors/codemirror-plugin/02-codemirror-example.png)
